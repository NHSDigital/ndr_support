...
class HashTest < ActiveSupport::TestCase
  ...
  test 'rawtext_merge without prevent_overwrite' do
    ...
    assert_equal({:a => 1, :b => 2, 'c' => '3', :rawtext => {'x' => 'apples', 'y' => 'pears', 'z' => 'oranges'}},
                 first_hash.rawtext_merge(second_hash, false))
    # Ensure original hashes are preserved
    assert_equal({:a => 1, :b => :two, :rawtext => {'x' => 'apples', 'y' => 'pears'}}, first_hash)
    assert_equal({:b => 2, 'c' => '3', :rawtext => {'y' => 'pears', 'z' => 'oranges'}}, second_hash)
  end
